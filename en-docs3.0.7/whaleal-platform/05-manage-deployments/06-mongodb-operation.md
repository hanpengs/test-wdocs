...
![mongodb-operation](../../images/whaleal-platform/05-manage-deployment/mongodb-operation.png)

### Connect to this instance

![connect](../../images/whaleal-platform/05-manage-deployment/connect.png)
...
![rename](../../images/whaleal-platform/05-manage-deployment/rename.png)
...
![version-modify](../../images/whaleal-platform/05-manage-deployment/version-modify.png)
...
![log-level](../../images/whaleal-platform/05-manage-deployment/log-level.png)
...
![convert-to-replSet](../../images/whaleal-platform/05-manage-deployment/convert-to-replSet.png)

Slandalone architecture-specific operation options.

### Convert to Sharded Cluster

![convert-to-sharded-cluster](../../images/whaleal-platform/05-manage-deployment/convert-to-sharded-cluster.png)
